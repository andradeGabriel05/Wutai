<section class="container text-center">
    <div class="row gx-0">
        ...
        while ($usuario = mysqli_fetch_assoc($product)) {
            ...
            echo '<img src="https://www.shutterstock.com/image-vector/beta-red-stamp-text-on-260nw-219686944.jpg" alt="..." class="img-thumbnail rounded-0" class="card-img-top" alt="...">';
